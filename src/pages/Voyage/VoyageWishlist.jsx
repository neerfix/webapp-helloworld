...
// Component
import VoyageTile from '@/components/VoyageTile'

class VoyageWishlistPage extends React.Component {
                ...
                <div>
                    <div id="voyagelist" className="mx-auto pt-5">
                        <div className="title-container pr-5">
                            <h1 className='h1'>Liste de souhaits</h1>
                        </div>
                        ...
                        <div className="container mx-auto">
                            <div className="travel-card relative rounded-xl bg-white py-5 mb-10">
                                ...
                                { !this.state.voyages && 
                                    <p>
                                        Aucun voyage dans la liste de souhaits
                                    </p>
                                }
                            </div>
                        </div>
...
export default VoyageWishlistPage;