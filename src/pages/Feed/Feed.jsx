				...
				<div id="bloc-feed" className="py-5">
					...
					<div className="mx-auto my-10 container">
						<div className="mx-5" id="feed-list">
							<FeedCard 
								voyage="Voyage au Kazakhstan" step="Volcan de glace" date="13/02/2022" user="John Doe" user_id="234533" voyage_id="234533" 
                            ...
                            <FeedCard 
                                voyage="Les Alpes" step="Village de Balazuc" date="24/12/2021" user="Patrick" user_id="234533" voyage_id="234567" 
                            ...
                            <FeedCard 
                                voyage="Roadtrip en Afrique" step="Etang à éléphants" date="30/09/2021"  user="Clement" user_id="234533" voyage_id="234799" 
							...
							<FeedCard 
                                voyage="Mon voyage au Japon" step="Mont Fuji-san" date="23/07/2021"  user="Emelicorne" user_id="234533" voyage_id="234799" 
